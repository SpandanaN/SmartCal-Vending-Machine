...
public class UserGUI {
	...
	private void initialize() throws IOException, ClassNotFoundException {
		...
		btnSuggestions.setBounds(307, 285, 182, 29);
		...
		btnPay.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(change < 0){
					...
					try {
						Database.updateCashInMachine(1, Double.parseDouble(ChangeTF.getText()));
					} catch (Exception e2) {
						e2.printStackTrace();
					} 
					JOptionPane.showMessageDialog(frmUserGui, "Please take your item.");
					//Update the count of the item in machine
					...
					//Update the total cost of that machine and count of the item
					try {
						Database.updateCostOfMachine(1, total);
		...
		btnBuyNewCard.setBounds(285, 260, 170, 29);
		...
		btnGetInfoFor.setBounds(68, 143, 199, 29);
		...
		btnQueryBasedOn.setBounds(288, 143, 199, 29);
		...
		lblSuggestions.setBounds(175, 6, 213, 37);
		...
		btnSearch.setBounds(215, 249, 117, 29);
		...
		rdbtnCalories.setBounds(48, 140, 159, 23);
		...
		rdbtnCalories_1.setBounds(215, 140, 159, 23);
		...
		rdbtnLowSugar.setBounds(368, 140, 141, 23);
